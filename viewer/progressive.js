...
function renderFrame(clip_T_camera) {
  ...
  submodel_T_world = gSubmodelTransform;
  submodel_T_camera = new THREE.Matrix4();
  submodel_T_camera.multiplyMatrices(submodel_T_world, world_T_camera);

  let currentScene = getRayMarchScene();
  currentScene
      .children[0]
      .material.uniforms['world_T_cam']['value'] = submodel_T_camera;
  currentScene
      .children[0]
      .material.uniforms['cam_T_clip']['value'] = camera_T_clip;
  currentScene
      .children[0]
      .material.uniforms['displayMode']['value'] = gDisplayMode - 0;

  gRenderer.clear();
  gRenderer.render(currentScene, gLowResBlitCamera);
}
